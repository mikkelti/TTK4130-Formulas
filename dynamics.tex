...
\todo[inline]{Add position, velocity and acceleration in Cartesian, cylindrical and spherical coordinates. Or at least the general formulas.}
...
\todo[inline]{Add the actual Newton-Euler equations.}
